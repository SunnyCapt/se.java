...
public class Main {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        setClientConfig();
        int attNum = 1;
        CommandWithObject<Creature> commandWrapper;
        final boolean[] closeApp = {false};
        Class clazz = Class.forName("capt.sunny.labs.l6.Creature");
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(System.in, charsetName))) {
            while (true) {
                ...
                try (Socket socket = new Socket("localhost", 1337);
                    ...
                    for (; ; ) {
                        ...
                        commandWrapper = new CommandWithObject<Creature>(multilineCommand, clazz);
